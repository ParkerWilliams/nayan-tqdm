...
(U+2607, 1-col) leads the charge.

Note: U+26A1 is 2 display cols; we use U+2607 (lightning symbol, 1 col).
...
def _emoji() -> Animation:
    ...
    # U+2607 = lightning symbol (1 col)
    sprite_a = Frame(lines=(f"{_WHT}\u2607{_RST}",))
    sprite_b = Frame(lines=(f"{_CYN}\u2607{_RST}",))
    completion = Frame(lines=(f"{_WHT}\u2607{_RST}\u2605",))   # lightning + star
