...
def _emoji() -> Animation:
    ...
    dec_a = Frame(lines=(
        "  ~  ^  ~     ^  ~  ^     ~  ^  ~     ^  ~  ^     ~  ^  ~     ^  ~  ^  ~",
        f"  {_MAG}\u2661{_RST}         {_RED}\u2661{_RST}          {_MAG}\u2661{_RST}         {_RED}\u2661{_RST}          {_MAG}\u2661{_RST}         {_RED}\u2661{_RST}          {_MAG}\u2661{_RST}         {_RED}\u2661{_RST}",
    ))
    dec_b = Frame(lines=(
        "    ^  ~  ^     ~  ^  ~     ^  ~     ^  ~  ^     ~  ^  ~     ^  ~  ^  ~  ^",
        f"     {_RED}\u2661{_RST}          {_MAG}\u2661{_RST}         {_RED}\u2661{_RST}          {_MAG}\u2661{_RST}         {_RED}\u2661{_RST}          {_MAG}\u2661{_RST}         {_RED}\u2661{_RST}       {_MAG}\u2661{_RST}",
    ))
